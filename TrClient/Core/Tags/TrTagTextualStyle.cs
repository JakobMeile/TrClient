// <copyright file="TrTagTextualStyle.cs" company="PlaceholderCompany">
...
namespace TrClient.Core.Tags
{
    ...
    public class TrTagTextualStyle : TrTagTextual
    {
        ...
        public TrTagTextualStyle(int sOffset, int sLength, string sType)
            : base("textStyle", sOffset, sLength)
        {
        ...
        public TrTagTextualStyle(string sProperties)
            : base("textStyle", sProperties)
        {
