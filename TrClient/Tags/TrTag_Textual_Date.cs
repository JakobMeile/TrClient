...
{
    public class TrTag_Textual_Date : TrTag_Textual
    {
        ...
        public TrTag_Textual_Date()
        {
        }

        public TrTag_Textual_Date(int sOffset, int sLength, DateTime sDate) : base("date", sOffset, sLength)
        {
        ...
        public TrTag_Textual_Date(int sOffset, int sLength, int sDay, int sMonth, int sYear) : base("date", sOffset, sLength)
        {
            // constructor for adding NEW tag programmatically
        ...
        public TrTag_Textual_Date(string sProperties) : base("date", sProperties)
        {
