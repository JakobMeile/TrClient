...
namespace TrClient
{
    public class clsTrStyleTag : clsTrTextualTag
    {
        ...
        public clsTrStyleTag(int sOffset, int sLength, string sType) : base("textStyle", sOffset, sLength)
        {
        ...
        public clsTrStyleTag(string sProperties) : base("textStyle", sProperties)
        {
