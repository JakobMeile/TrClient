...
namespace TrClient
{
    public class clsTrRomanNumeralTag : clsTrTextualTag
    {
        ...
        public clsTrRomanNumeralTag(int sOffset, int sLength, string sRomanValue) : base("romanNumeral", sOffset, sLength)
        {
        ...
        public clsTrRomanNumeralTag(string sProperties) : base("romanNumeral", sProperties)
        {
