...
namespace TrClient
{
    public class clsTrWord : IComparable, INotifyPropertyChanged
    {
        public clsTrWords ParentContainer { get; set; }
        public clsTrWord Previous { get; set; }
        public clsTrWord Next { get; set; }

        public int ContextSize = 10;

        private clsTrPage _parentPage;
        ...
        private clsTrTextRegion _parentRegion;
        ...
        public string Context
        {
            get
            {
                ...
                {
                    clsTrWord NextWord = Next;
                    clsTrWord PreviousWord = Previous;
                    string After = "";
                    string Before = "";
        ...
        // Constructor
        public clsTrWord(string Text, clsTrTextLine SourceLine)   // , int Position
        {
            Raw = Text.Trim();
