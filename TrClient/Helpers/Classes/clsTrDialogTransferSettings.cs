...
namespace TrClient
{
    public class clsTrDialogTransferSettings : INotifyPropertyChanged
    {
        ...
        public clsTrDialogTransferSettings()
        {
        ...
        public clsTrDialogTransferSettings(int MaxPages) : this()
        {
            PagesTo = MaxPages;
        }

        public clsTrDialogTransferSettings(int MaxPages, int MaxRegions) : this(MaxPages)
        {
